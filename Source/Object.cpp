...
{
  return visible_ ? visible_color_ : invisible_color_;
}
...
{
  construction_->recreate(equation_);
...
Circle::Circle(Point* first, Point* second, Point* third, Point* fourth)
{
  ...
  construction_ = new ByFourPoints(this, first, second, third, fourth);
...
void Line::printExpr()
{
  ConstructionLine* cl = dynamic_cast<ConstructionLine*>(construction_);
  (cl->z_coef).print();
  std::cout << std::endl;
...
Line::Line(Line* first, Point* second)
{
  first->addChild(this);
  second->addChild(this);
  construction_ = new Parallel(this, first, second);
...
Line::Line(Point* first, Line* second)
{
  first->addChild(this);
  second->addChild(this);
  construction_ = new Perpendicular(this, first, second);
  equation_ = new LineEquation(0, 0, 0);
  Reposition();
  Init();
}
...
{
  ConstructionLine* constr = dynamic_cast<ConstructionLine*>(construction_);
  std::string TeX_;
...
Line::Line(UnitCircle* first, Point* second)
{
  first->addChild(this);
  second->addChild(this);
  construction_ = new Tangent(this, first, second);
  equation_ = new LineEquation(0, 0, 0);
  Reposition();
  Init();
}
...
Line::Line(Point* first, Point* second)
{
  first->addChild(this);
  second->addChild(this);
  construction_ = new ByTwoPoints(this, first, second);
  equation_ = new LineEquation(0, 0, 0);
  Reposition();
  Init();
}
...
LineSegment::LineSegment(Point* first, Point* second)
{
  ...
  construction_ = new ByTwoEnds(this, first, second);
...
Chord::Chord(UnitPoint* first, UnitPoint* second)
{
  first->addChild(this);
  second->addChild(this);
  construction_ = new ByTwoUnitPoints(this, first, second);
  equation_ = new LineEquation(0, 0, 0);
  Reposition();
  Init();
}
...
{
  setName();
  construction_ = new byTwoPointsFixedRatio(this, first, second, masses);
  first->addChild(this);
  second->addChild(this);
  Init();
}
...
{
  dynamic_cast<ConstructionPoint*>(construction_)->moveTo(coords);
  construction_->recreate(equation_);
  ReposeChildren();
}
...
Point::Point(Vector2f position)
{
  ...
  setName();
  construction_ = new OnPlane(this, position);
  Init();
}
...
{
  setName();
  construction_ = new IntersectionOfTwoLines(this, first, second);
  first->addChild(this);
  second->addChild(this);
  Init();
}
...
Point::Point(Line* points_, Point* first, Point* second, Vector2f position)
{
  SetColor(movable_color_);
  setName();
  construction_ = new OnLine(this, first, second, 0, points_);
  first->addChild(this);
  second->addChild(this);
...
{
  setName();
  construction_ = new Projection(this, point, points_);
  point->addChild(this);
  points_->addChild(this);
  Init();
}
...
Point::Point(UnitPoint* first, UnitPoint* second, UnitPoint* third, triangleCenter center)
{
  ...
  {
    case ORTHOCENTER:
    construction_ = new Orthocenter(this, first, second, third);
    break;
    case INCENTER:
    construction_ = new Incenter(this, first, second, third);
    break;
  }
  first->addChild(this);
  second->addChild(this);
...
{
  setName();
  construction_ = new Barycenter(this, first, second, third);
  first->addChild(this);
  second->addChild(this);
  third->addChild(this);
  Init();
...
{
  ConstructionPoint* cp = dynamic_cast<ConstructionPoint*>(construction_);
  cp->coord.print();
  std::cout << std::endl;
}
...
{
  setName();
  construction_ = new Rotation90(this, center, preimage, sign);
...
{
  return dynamic_cast<ConstructionPoint*>(construction_)->coord.getTEXformat();
}
...
UnitPoint::UnitPoint(UnitCircle* unit_circle, Vector2f position)
{
  ...
  construction_ = new OnCircle(this, unit_circle, angle);
...
{
  setName();
  construction_ = new CentralProjection(this, unit_circle, first, second);
  unit_circle->addChild(this);
  first->addChild(this);
  second->addChild(this);
  Init();
...
{
  setName();
  construction_ = new IntersectionPerpendicularChord(this, unit_circle, point, chord);
  unit_circle->addChild(this);
  chord->addChild(this);
  point->addChild(this);
  Init();
...
{
  setName();
  construction_ = new IntersectionParallelChord(this, unit_circle, chord, point);
  unit_circle->addChild(this);
  chord->addChild(this);
  point->addChild(this);
  Init();
