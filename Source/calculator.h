...
namespace calc
{
	...
	// represents operation tree whose leaves are multi-variable polynomials
	// all constructors of subclasses are private, use create() to create a shared_ptr on a new object
	...
	public:
		...
		virtual const std::string getTEXformat() const = 0;
	...
	public:
		...
		virtual const std::string getTEXformat() const;
	};
	...
	struct monomial
	{
		...
		const std::string getTEXformat() const;
	};
